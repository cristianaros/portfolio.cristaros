...
## 2024-04-10 - Accesibilidad por teclado en controles de juegos
**Learning:** Los botones D-pad en minijuegos que solo utilizan `onMouseDown` excluyen a los usuarios de teclado, y carecen de roles/etiquetas explícitas.
**Action:** Siempre incluir manejadores `onClick` junto con `onMouseDown`, proporcionar `aria-label` y `title` en español, y aplicar estilos de foco estándar (`focus-visible`).

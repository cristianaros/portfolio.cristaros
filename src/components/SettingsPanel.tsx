...
const SettingsToggle: React.FC<{
  ...
  <div className="flex items-center justify-between py-2 px-1 group">
    ...
    <button
      ...
      className={`relative w-9 h-5 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-vscode-accent focus-visible:outline-none ${
  ...
  return (
    <>
      ...
      <button
        ...
        className={`w-10 h-10 flex items-center justify-center transition-colors rounded-md focus-visible:ring-1 focus-visible:ring-vscode-accent focus-visible:outline-none ${
          isOpen

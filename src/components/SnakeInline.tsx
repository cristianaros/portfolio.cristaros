    ...
    <div className="flex items-center justify-center h-full w-full overflow-auto py-6 px-4">
      ...
      <div className="bg-[#2c2c3a] rounded-[2rem] p-4 sm:p-6 shadow-2xl border border-[#45475a] max-w-full" style={{ minWidth: 'min(340px, 100%)' }}>
        ...
        <div className="flex flex-col items-center mt-4 gap-1">
          <div className="flex gap-1">
            ...
            <button
              ...
              className="w-10 h-10 rounded-t-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors focus-visible:ring-2 focus-visible:ring-[#cdd6f4] focus-visible:outline-none"
            >▲</button>
            <div className="w-10 h-10" />
          </div>
          <div className="flex gap-1">
            <button
              ...
              className="w-10 h-10 rounded-l-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors focus-visible:ring-2 focus-visible:ring-[#cdd6f4] focus-visible:outline-none"
            >◄</button>
            ...
            <button
              ...
              className="w-10 h-10 rounded-r-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors focus-visible:ring-2 focus-visible:ring-[#cdd6f4] focus-visible:outline-none"
            >►</button>
          </div>
          <div className="flex gap-1">
            <div className="w-10 h-10" />
            <button
              ...
              className="w-10 h-10 rounded-b-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors focus-visible:ring-2 focus-visible:ring-[#cdd6f4] focus-visible:outline-none"
            >▼</button>
            <div className="w-10 h-10" />
          </div>
        </div>
        ...
        <div className="flex justify-center gap-8 mt-3">
          <button
            onClick={startGame}
            aria-label="Iniciar o reiniciar juego"
            title="Iniciar o reiniciar juego"
            className="w-10 h-10 rounded-full bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[10px] text-[#cdd6f4] font-bold transition-colors focus-visible:ring-2 focus-visible:ring-[#cdd6f4] focus-visible:outline-none"
          >A</button>
          <button

        ...
        <div className="flex flex-col items-center mt-4 gap-1">
          <div className="flex gap-1">
            ...
            <button
              ...
              aria-label="Arriba"
              title="Arriba"
              className="w-10 h-10 rounded-t-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors focus-visible:ring-1 focus-visible:ring-vscode-accent focus-visible:outline-none z-10"
            >▲</button>
            <div className="w-10 h-10" />
          </div>
          <div className="flex gap-1">
            <button
              ...
              title="Izquierda"
              className="w-10 h-10 rounded-l-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors focus-visible:ring-1 focus-visible:ring-vscode-accent focus-visible:outline-none z-10"
            >◄</button>
            ...
            <button
              ...
              aria-label="Derecha"
              title="Derecha"
              className="w-10 h-10 rounded-r-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors focus-visible:ring-1 focus-visible:ring-vscode-accent focus-visible:outline-none z-10"
            >►</button>
          </div>
          <div className="flex gap-1">
            <div className="w-10 h-10" />
            <button
              ...
              aria-label="Abajo"
              title="Abajo"
              className="w-10 h-10 rounded-b-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors focus-visible:ring-1 focus-visible:ring-vscode-accent focus-visible:outline-none z-10"
            >▼</button>
            <div className="w-10 h-10" />
          </div>
        </div>

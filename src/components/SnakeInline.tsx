    ...
    <div className="flex items-center justify-center h-full w-full overflow-auto py-6 px-4">
      ...
      <div className="bg-[#2c2c3a] rounded-[2rem] p-4 sm:p-6 shadow-2xl border border-[#45475a] max-w-full" style={{ minWidth: 'min(340px, 100%)' }}>
        ...
        <div className="flex flex-col items-center mt-4 gap-1">
          <div className="flex gap-1">
            ...
            <button
              ...
              aria-label="Arriba"
              title="Arriba"
              className="w-10 h-10 rounded-t-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors px-1 focus-visible:ring-1 focus-visible:ring-vscode-accent focus-visible:outline-none"
            >▲</button>
            <div className="w-10 h-10" />
          </div>
          <div className="flex gap-1">
            <button
              ...
              title="Izquierda"
              className="w-10 h-10 rounded-l-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors px-1 focus-visible:ring-1 focus-visible:ring-vscode-accent focus-visible:outline-none"
            >◄</button>
            ...
            <button
              ...
              aria-label="Derecha"
              title="Derecha"
              className="w-10 h-10 rounded-r-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors px-1 focus-visible:ring-1 focus-visible:ring-vscode-accent focus-visible:outline-none"
            >►</button>
          </div>
          <div className="flex gap-1">
            <div className="w-10 h-10" />
            <button
              ...
              aria-label="Abajo"
              title="Abajo"
              className="w-10 h-10 rounded-b-lg bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[#cdd6f4] transition-colors px-1 focus-visible:ring-1 focus-visible:ring-vscode-accent focus-visible:outline-none"
            >▼</button>
            <div className="w-10 h-10" />
          </div>
        </div>
        ...
        <div className="flex justify-center gap-8 mt-3">
          <button
            onClick={startGame}
            aria-label="Botón A (Iniciar juego)"
            title="Botón A (Iniciar juego)"
            className="w-10 h-10 rounded-full bg-[#45475a] hover:bg-[#585b70] active:bg-[#313244] flex items-center justify-center text-[10px] text-[#cdd6f4] font-bold transition-colors px-1 focus-visible:ring-1 focus-visible:ring-vscode-accent focus-visible:outline-none"
          >A</button>
          <button
            aria-label="Botón B"
            title="Botón B"

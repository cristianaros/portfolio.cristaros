    ...
    <div className="border-t border-vscode-border bg-vscode-terminal mt-auto">
      ...
      <div className="flex items-center justify-between px-4 py-1.5 border-b border-vscode-border bg-vscode-tabs">
        ...
        <div className="flex items-center gap-2 text-vscode-textMuted">
          <button className="hover:text-vscode-text transition-colors text-lg leading-none" aria-label="Nueva terminal" title="Nueva terminal">+</button>
          <button className="hover:text-vscode-text transition-colors text-sm leading-none" aria-label="Maximizar panel" title="Maximizar panel">⌃</button>
          <button className="hover:text-vscode-text transition-colors text-sm leading-none" aria-label="Cerrar terminal" title="Cerrar terminal">×</button>
        </div>
      </div>
